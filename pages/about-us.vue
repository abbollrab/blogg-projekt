<template>
    <div class="min-h-screen bg-coolgray">
        ...
        <div class="flex flex-nowrap pl-2 bg-white rounded-2xl my-10 ">
            <div class="py-5">
                <p
                    class="w-2/3"
            ...
            <div>
                <img
                    class="w-1/2 float-right py-4"
                    src="https://cdn.discordapp.com/attachments/792446407268630581/963809010589519903/623F22C5-06F0-4816-A011-F31AD7E4E44D.jpg"
                />
            </div>
        </div>
    </div>
...
<style>
.image-1 {
    background-image: url("https://9cover.com/images/ccovers/1465145564mountain-lake-nature.jpg"); /* The image used */
    height: 300px;
